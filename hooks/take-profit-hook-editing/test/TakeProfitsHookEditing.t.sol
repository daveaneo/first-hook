...
import {TakeProfitsHookEditing} from "../src/TakeProfitsHookEditing.sol";

contract TakeProfitsHookEditingTest is Test, Deployers, ERC1155Holder {
    // Use the libraries
    using StateLibrary for IPoolManager;

    TakeProfitsHookEditing hook;
    ...
    function setUp() public {
        ...
        deployCodeTo(
            "TakeProfitsHookEditing.sol",
            abi.encode(manager, ""),
            hookAddress
        );
        hook = TakeProfitsHookEditing(hookAddress);
