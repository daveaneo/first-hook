...
import {GasPriceFeesHookEditing} from "../src/GasPriceFeesHookEditing.sol";
import {TickMath} from "v4-core/libraries/TickMath.sol";
import {SwapParams, ModifyLiquidityParams} from "v4-core/types/PoolOperation.sol";
import {console} from "forge-std/console.sol";

contract TestGasPriceFeesHookEditing is Test, Deployers {
    using CurrencyLibrary for Currency;

    GasPriceFeesHookEditing hook;
    ...
    function setUp() public {
        ...
        deployCodeTo("GasPriceFeesHookEditing.sol", abi.encode(manager), hookAddress);
        hook = GasPriceFeesHookEditing(hookAddress);
