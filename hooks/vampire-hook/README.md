...
```bash
forge test --match-path hooks/gas-price-fees-hook/test/GasPriceFeesHookEditing.t.sol -vv
```
...
- Source: `src/GasPriceFeesHookEditing.sol`
- Tests: `test/GasPriceFeesHookEditing.t.sol`
